...
def __init__(self, sln, course_code, course_title, restrictions, section_id, credits, dates, times, building, room, instructor, status, enrollment, enrollment_limit, grading, course_fee, modality, other):
    self.sln = sln
